...
def update_data():
    ...
    df_final['SGD Price'] = df_final['Price SGD'].replace('NA',0)
    ...
    df_final['SGD Price'] = df_final['Price SGD'].astype(float).astype(int)
    ...
    df_final['SGD Price'] = df_final['Price SGD'].replace(0, 'NA')
