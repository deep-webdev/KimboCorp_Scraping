...
def start():
    ...
    scheduler.add_job(sdbullion.update_data, 'interval', minutes=70)
    scheduler.add_job(apmex.update_data, 'interval', minutes=70)
    scheduler.add_job(goldsilvercentral.update_data, 'interval', minutes=70)
